...
This program is used by the Dallas Makerspace for managing our TODO list:

[https://dallasmakerspace.org/todo/](https://dallasmakerspace.org/todo/)
...
1. Download the latest version with git (`git clone https://github.com/Dallas-Makerspace/ToDo`)
